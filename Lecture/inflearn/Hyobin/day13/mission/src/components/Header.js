...
export default function Header({$app, initialState, handleClick, handleSearch}) {
    ...
    this.template = () => {
        ...
        <img src='../src/img/ball.webp' width=40px height=40px alt="ball"></img>
        포켓몬 도감</div>`;
        ...
        if (!currentPage.includes('/detail')) {
            ...
            <input type="text" placeholder="포켓몬을 검색하세요!" id="search" autocomplete="off" value=${decodeURIComponent(searchWord)}></input>
